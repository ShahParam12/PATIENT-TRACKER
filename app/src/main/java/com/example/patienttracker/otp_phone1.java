...
public class otp_phone1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otp_phone1);
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(otp_phone1.this, new OnCompleteListener<AuthResult>() {
                    @Override
    ...
    public void sendUserToHome() {
        Intent intent=new Intent(otp_phone1.this,Main3Activity.class);
