...
public class Main3Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2=(Button)findViewById(R.id.goal);
        b3=(Button)findViewById(R.id.education);
        b4=(Button)findViewById(R.id.buttoncomfort);

        b5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Main3Activity.this,Reports.class);
                startActivity(i);
            }
        });
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Main3Activity.this,list.class);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Main3Activity.this,appointment.class);
                startActivity(intent);
            }
        });
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Main3Activity.this,feedback.class);
                startActivity(intent);
            }
        });
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseAuth.getCurrentUser() == null) {
                    ...
                    startActivity(new Intent(Main3Activity.this, login_form1.class));
                }
            }
        };
        ...
        buttonn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(Main3Activity.this,login_form1.class);
                startActivity(i);
        ...
        toolbar.setTitle("");
        toolbarTitle.setText("DOCTOR'S LOGIN");
