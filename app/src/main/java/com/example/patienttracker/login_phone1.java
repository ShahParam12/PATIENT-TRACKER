...
public class login_phone1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_phone1);
        ...
        mcall=new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(final String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                new android.os.Handler().postDelayed(
                        new Runnable(){
                            public void run(){
                                Intent intent=new Intent(login_phone1.this,otp_phone1.class);
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(login_phone1.this, new OnCompleteListener<AuthResult>() {
                    @Override
    ...
    private void sendUserToHome(){
        Intent intent=new Intent(login_phone1.this,Main3Activity.class);
